...
export default function Index(auth) {
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={
        <h2 className="text-xl leading-tight text-gray-800 font semibold">
          Roles
        </h2>
      }
    >
                ...
                <tr key={i}>
                  ...
                  <Table.Td>
                    <div className="flex flex-wrap items-center gap-2">
                      {role.name == "admin" ? (
                        <span className="inline-flex items-center px-3 py-1 text-sm rounded-full bg-sky-100 text-sky-700">
                          all-permissions
                        </span>
                      ) : (
